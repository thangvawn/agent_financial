...
def test_ai_assistant_route_removed(monkeypatch):
    reset_home_onboarding_state()
    reset_financial_health_state()
    reset_goals_state()
...
@pytest.mark.skip(reason="community module unmounted (Phase 4)")
...
@pytest.mark.skip(reason="guided_investing disabled by default (Phase 4)")
