export default function ProLabBlueprintsPage({
  ...
  if (!workspace) {
    return <p className="text-sm text-[#a6c1c8]">Mở phòng mô phỏng để dựng chiến lược mua/bán giả lập.</p>
  }
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-6 items-start">
      <section className="p-5 rounded-2xl bg-[#101d26]/60 border border-[#88aab8]/15 shadow-md flex flex-col gap-4 lg:col-span-2">
        <div className="flex justify-between items-start gap-4 flex-wrap pb-2">
          <div>
            <p className="text-[9px] font-bold text-[#5e7a72] uppercase tracking-wider">Strategy Builder</p>
            <h2 className="text-sm font-bold text-white uppercase tracking-wider mt-1">Thiết lập quy tắc mua/bán giả lập</h2>
            <p className="text-xs text-[#88aab8] mt-2">Dựa trên chỉ số cơ bản hoặc tín hiệu kỹ thuật — chỉ để thực hành, không phải lệnh thật.</p>
          </div>
          <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#4fd1b4]/10 text-[#4fd1b4] border border-[#4fd1b4]/20">{selectedBlueprintId ? 'Đang sửa chiến lược' : 'Chiến lược mới'}</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-2">
          <article className="p-4 rounded-xl bg-[#0c1720]/40 border border-[#88aab8]/10 flex flex-col gap-1">
            <strong className="text-xs font-bold text-[#4fd1b4] uppercase tracking-wider">Mục tiêu</strong>
          ...
          <article className="p-4 rounded-xl bg-[#0c1720]/40 border border-[#88aab8]/10 flex flex-col gap-1">
            ...
            <span className="text-xs text-[#88aab8] leading-relaxed">Những mã được phép vào giả lập?</span>
          </article>
          <article className="p-4 rounded-xl bg-[#0c1720]/40 border border-[#88aab8]/10 flex flex-col gap-1">
            <strong className="text-xs font-bold text-[#4fd1b4] uppercase tracking-wider">Benchmark</strong>
            <span className="text-xs text-[#88aab8] leading-relaxed">So với chuẩn nào (vd. VNINDEX)?</span>
          </article>
          <article className="p-4 rounded-xl bg-[#0c1720]/40 border border-[#88aab8]/10 flex flex-col gap-1">
            <strong className="text-xs font-bold text-[#4fd1b4] uppercase tracking-wider">Rủi ro</strong>
            <span className="text-xs text-[#88aab8] leading-relaxed">Ngưỡng cắt lỗ / giới hạn vị thế?</span>
          </article>
        </div>
      </section>

      <section className="p-5 rounded-2xl bg-[#101d26]/60 border border-[#88aab8]/15 shadow-md flex flex-col gap-4">
        <p className="text-[9px] font-bold text-[#5e7a72] uppercase tracking-wider">Quy tắc chiến lược</p>
