      ...
      <div className="hidden lg:flex flex-col justify-between p-16 bg-zinc-950/40 border-r border-zinc-900/50 relative overflow-hidden">
        ...
        <div className="relative z-10 my-auto py-12 space-y-8 max-w-md">
          ...
          <div className="space-y-3.5">
            {[
              { icon: <ShieldIcon className="w-4 h-4 text-teal-400" />, text: "Minh bạch mục đích: giáo dục, không đưa lệnh mua bán" },
              { icon: <ChartIcon className="w-4 h-4 text-teal-400" />, text: "Đọc dữ liệu thị trường và báo cáo tài chính có ngữ cảnh" },
              { icon: <TargetIcon className="w-4 h-4 text-teal-400" />, text: "Luyện đặt lệnh và kiểm tra chiến lược bằng dữ liệu mô phỏng" },
              { icon: <BookIcon className="w-4 h-4 text-teal-400" />, text: "Thư viện video, sách và tài liệu học tài chính" }
            ].map((item, idx) => (
              <div 
                key={idx} 
              ...
              >
                ...
                <p className="text-sm font-medium text-zinc-300 pt-0.5 transition-colors">
                  {item.text}
                </p>
              </div>
            ))}
